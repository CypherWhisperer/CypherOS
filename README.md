...
> **Note:** Adjust partition numbers to match your disk. On NVMe drives the naming is typically `/dev/nvme0n1p1` and `/dev/nvme0n1p2`.
...
Remove the USB drive when the screen goes black during shutdown. The system will boot into GDM.
